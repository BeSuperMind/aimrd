...
class _MeditateScreenState extends State<MeditateScreen> {
  ...
  Future<void> _initCamera() async {
    ...
    try {
      ...
      log(
          _cameraController.value.previewSize!.width.toString() +
              "---" +
              _cameraController.value.previewSize!.height.toString(),
          name: "CAMERA_SIZE");
    } catch (e) {
                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: [
                      ...
                      // Draw the face bounding box if faces are detected
                      if (_faces != null && _faces!.isNotEmpty)
                        CustomPaint(
                          ...
                          painter: FacePainter(
                            face: firstFace, // Use the first detected face
                            imageSize: Size(
                              _cameraController.value.previewSize!.width,
                              _cameraController.value.previewSize!.height,
                            ),
